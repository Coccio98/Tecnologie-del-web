                ...
                <div>
                    @for($i = 0; $i < sizeof($newProducts[0]); $i++)
                        @component('partials.reusable.widget')
                            @if(!empty($newProducts[0][$i]->image)){{$newProducts[0][$i]->image}}@else {{asset('storage/images/no_image.jpg')}} @endif
                            @slot('category')
                                Laptop
                            @endslot
                            @slot('name')
            ...
            @slot('widgets')
                <div>
                    @for($i = 0; $i < sizeof($topSelling[0]); $i++)
                        @component('partials.reusable.widget')
                            @if(!empty($topSelling[0][$i]->image)){{$topSelling[0][$i]->image}}@else {{asset('storage/images/no_image.jpg')}} @endif
                            @slot('category')
                                <br/>
                            @endslot
                            @slot('name')
